...
class WhatsAppController extends Controller
{
    ...
    {
        return $this->channelIndex($request, 'whatsapp');
    }
    ...
    public function send(Request $request, MessagingService $service): RedirectResponse
    {
        ...
        return redirect()->route('whatsapp.index')
            ->with('success', 'WhatsApp message sent (logged).');
    }
    ...
    private function channelIndex(Request $request, string $channel): Response
    {
        ...
        return Inertia::render('Messaging/Channel', [
            'channel' => $channel,
            'title' => $channel === 'whatsapp' ? 'WhatsApp' : 'Email',
            'templates' => $templates,
            'messages' => $messages,
